  ...
  defaultMarketplaceExtensions = mkMarketplaceExts [
    {
      ...
      publisher = "anthropic";
      version = "2.0.9";
      sha256 = "sha256-uVCdFSpitKU0YPbhl1kbogrQ+bckhH6GYTd7GPjrMRA=";
    }
    {
    ...
    }
    {
      ...
      version = "0.4.24";
      sha256 = "sha256-xtMXd8GVHygl9+9X+QamI5YXXSlvEWOoYKf3OWmIoHw=";
    }
    {
      name = "vscode-websearchforcopilot";
      publisher = "ms-vscode";
      version = "0.1.2025101401";
      sha256 = "sha256-XoZZbKtu6Mqd3HseUFIDOImh91iCu5pKQJDjH/QT554=";
    }
    {
      name = "gitignore";
